...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/09 17:39:27 by ktakami           #+#    #+#             */
/*   Updated: 2020/11/09 17:39:27 by ktakami          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
inline bool box_compare(
	const shared_ptr<hitable> a, const shared_ptr<hitable> b, int axis
) {
	aabb box_a;
	aabb box_b;
...
bool box_x_compare (
	const shared_ptr<hitable> a, const shared_ptr<hitable> b
) {
